...
import org.astral.findmaimaiultra.adapter.ReviewAdapter;
import org.astral.findmaimaiultra.been.Market;
...
// 创建是否使用输入框及其标签
    ...
    private void startAmap() {
        // 高德地图
        Intent intent = new Intent("android.intent.action.VIEW", Uri.parse("androidamap://route?sourceApplication=appName&slat=&slon=&sname=我的位置&dlat=" + tagXY[1] +"&dlon="+ tagXY[0]+"&dname=" +tagplace + "&dev=0&t=2"));
    ...
    private void startBaiduMaps() {
        ...
        Intent intent = new Intent("com.baidu.tieba",  Uri.parse(uri));
        startActivity(intent);
    }
